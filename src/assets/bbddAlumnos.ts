export const alumnado = [{"id":1,"first_name":"Sascha","last_name":"Pennington","email":"spennington0@abc.net.au","avatar":"https://robohash.org/voluptatemautvel.png?size=50x50&set=set1"},
